...
For now, only focus on what the code does and the roxygen-documentation (not vignettes nor test suite). You can check outputs in vignettes as part of checking package functionality and especially see vignettes/formulas.Rmd how the model is intended to work. Take your time. Report what changes would improve your experience as a user and confidence in mcp as a statistician.
