 ...
 * *group-level change points*: To my knowledge, no other package implements group-level change-point deviations while sharing population-level effects. Read more about [group-level change points](../articles/varying.html) in `mcp`.
