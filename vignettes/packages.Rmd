...
There are a lot of change point packages out there already, so why `mcp`? Here are my (probably biased) thoughts about this. I compiled some tables, summarising change point packages ([.xlsx file here](../man/figures/packages_tables.xlsx)). I will demonstrate each of these packages in an applied example below to discuss their merits and shortcomings. 

![](../man/figures/packages_table1.png)
![](../man/figures/packages_table2.png)
![](../man/figures/packages_table3.png)
