...
There are a lot of change point packages out there already, so why `mcp`? Here are my (probably biased) thoughts about this. I compiled some tables, summarising change point packages ([.xlsx file here](https://github.com/lindeloev/mcp/raw/master/vignettes/_figures/packages_tables.xlsx)). I will demonstrate each of these packages in an applied example below to discuss their merits and shortcomings. I recommend [this nice overview](http://stats.lse.ac.uk/fryzlewicz/wbs2/wbs2sdll.pdf) of the methodologies used in many of these packages.
...
![](https://github.com/lindeloev/mcp/raw/master/vignettes/_figures/packages_table1.png)
...
![](https://github.com/lindeloev/mcp/raw/master/vignettes/_figures/packages_table2.png)
...
![](https://github.com/lindeloev/mcp/raw/master/vignettes/_figures/packages_table3.png)
