 ...
 * *Per-segment regression on Gaussian residual standard deviation and serial dependence* via the `sigma()` ([read more here](../articles/variance.html)), `ar()`, and `ma()` ([read more here](../articles/arma.html)) terms, also allowing for more advanced change points involving, e.g., a change in autocorrelation strength.
