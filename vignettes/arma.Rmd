...
The default prior on both AR and MA intercepts is `dunif(-1, 1)`. This bounds each coefficient but does not by itself guarantee joint stationarity or invertibility for orders above one. For many time series, you would expect a positive first-order autocorrelation, e.g., `ar1_1 = "dunif(0, 1)"` or `ar1_1 = "dnorm(0.5, 0.5) T(0, 1)"`. [Read more about priors](../articles/priors.html). Higher-order and MA priors should reflect the plausible dependence structure for the application.
