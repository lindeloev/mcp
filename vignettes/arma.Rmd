...
You could use `plot(fit, geom_data = "line")` for a more classical line plot of the time series data. You can also plot the `ar1_` parameters directly. Now the y-axis is `ar1`:
