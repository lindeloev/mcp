...
*NOTE: the default prior is unfit for `hypothesis` for models with 2+ change points. The Dirichlet prior may be a better alternative. [Read more here](../docs/articles/priors.html).*
