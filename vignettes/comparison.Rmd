...
data = tibble::tibble(
  ...
  recalled = empty$simulate(items, int_1 = 2.5, items_2 = -0.4, cp_1 = 4, sigma = 0.5)
)
```
...
fit_default = mcp(segments, data, family = binomial(), sample = "both", iter = 10000)
fit_info = mcp(segments, data, prior, family = binomial(), sample = "both", iter = 10000)
fit_simple = mcp(segments_simple, data, family = binomial(), sample = "both", iter = 10000)
```
