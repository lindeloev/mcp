...
Slope scales are divided by the expected segment width, `(max(x) - min(x)) / n_segments()`. The implied change across a typical segment therefore has the same 2.5-logit scale, even when the model contains several change points.
