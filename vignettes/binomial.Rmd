---
title: "Binomial change point detection with mcp"
author: "Jonas Kristoffer Lindeløv"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Binomial change point detection with mcp}
  %\VignetteEngine{knitr::rmarkdown}
  \usepackage[utf8]{inputenc}
---

<!--
Add links to other vignettes
-->

`mcp` aims to implement Generalized Linear Models in a way that closely mimicks that of [brms::brm](https://github.com/paul-buerkner/brms). You can set the family and link functions using the `family` argument.
...
`summary` uses 95% highest density intervals (HDI) by default, but you can change it using `summary(fit, width = 0.80)`. If you have varying effects, use `ranef(fit)` to see them.
