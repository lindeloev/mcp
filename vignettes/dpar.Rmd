...
- Segment 4: Without a new `sigma()` term, the standard-deviation model persists from segment 3; because no new slope on $x$ is declared for `sigma()`, it forms a flat plateau continuing from the level reached at `cp_3`.
