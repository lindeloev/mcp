...
`summary()` shows that the parameters are well recovered. The last change point is estimated with greater uncertainty than the others because its only signal is a stop in standard-deviation growth.
