...
This confirms the impression from `rhat`, `ess_bulk`, and `ess_tail`. Increasing `iter` further would improve the effective sample size. Read more about [tips, tricks, and debugging](../articles/tips.html).
