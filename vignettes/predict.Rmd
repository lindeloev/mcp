 ...
 * **error:** The posterior standard deviation of the expected response corresponding to `fitted`. In `predict()` output, `error` is instead the posterior predictive standard deviation.
