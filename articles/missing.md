...
[`plot()`](https://lindeloev.github.io/mcp/reference/plot.mcpfit.md) are
evaluated on data made by
...
- Include [continuous and categorical
  predictors](https://lindeloev.github.io/mcp/articles/formulas.md) so
  imputations follow observed covariate information.
- Use [group-level
  effects](https://lindeloev.github.io/mcp/articles/group_effects.md) so
  sparsely observed groups borrow information from the population and
  their available observations.
- [Model changing residual standard deviation with
  `sigma()`](https://lindeloev.github.io/mcp/articles/dpar.md) so
  imputation uncertainty can vary over the predictor range.
- Use [binomial, Bernoulli, Poisson, or negative-binomial
  responses](https://lindeloev.github.io/mcp/articles/families.md).
...
[`loo()`](https://lindeloev.github.io/mcp/reference/loo.mcpfit.md), or
[`waic()`](https://lindeloev.github.io/mcp/reference/loo.mcpfit.md). For
