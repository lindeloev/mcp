...
test_that("Gaussian 2-changepoint model agrees with segmented()", {
  ...
  fit_mcp = mcp(model, df, family = gaussian(), adapt = 500, iter = 2000, seed = 42, warn = FALSE, quiet = TRUE)
...
test_that("Poisson 2-changepoint model agrees with segmented()", {
  ...
  fit_mcp = mcp(model, df, family = poisson(), adapt = 500, iter = 2000, seed = 123, warn = FALSE, quiet = TRUE)
...
test_that("Binomial 2-changepoint model agrees with segmented()", {
  ...
  fit_mcp = mcp(model, df, family = binomial(), adapt = 500, iter = 2000, seed = 42, warn = FALSE, quiet = TRUE)
  ...
  # Compare parameters (within 0.05)
  testthat::expect_equal(intercept_mcp, intercept_seg, tolerance = 0.05)
  testthat::expect_equal(x1_mcp, unname(slopes_seg["slope1"]), tolerance = 0.02)
})
