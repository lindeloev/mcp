...
test_that("mcp seed reproduces prior and posterior samples", {
  ...
  expect_identical(fit_1$mcmc_post, fit_2$mcmc_post)
  expect_identical(fit_1$mcmc_prior, fit_2$mcmc_prior)
  expect_false(identical(fit_1$mcmc_post, fit_3$mcmc_post))
  expect_false(identical(fit_1$mcmc_prior, fit_3$mcmc_prior))
  expect_false(identical(fit_1$mcmc_post[[1]], fit_1$mcmc_post[[2]]))
})
